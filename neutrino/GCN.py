...
class GCN(nn.Module):
    ...
    def fit(self, features, adj, labels, idx_train, idx_val=None, train_iters=100, initialize=True, verbose=False, normalize=True, patience=500):
        '''
    ...
    def _train_with_val(self, labels, idx_train, idx_val, train_iters, verbose):
        ...
        for i in range(train_iters):
            ...
            if acc_val > best_acc_val:
                ...
                print('iter %d, acc ' % i, best_acc_val)
                self.output = output
                weights = deepcopy(self.state_dict())
